...
@Component({
  selector: 'trade-transactions-toolbar',
  templateUrl: './trade-transactions-toolbar.template.html'
})
export class TradeTransactionsToolbarComponent implements OnInit {
