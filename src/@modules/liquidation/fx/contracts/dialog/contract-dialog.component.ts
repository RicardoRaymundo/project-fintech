...
import {ContractDialogInterface} from './contract-dialog.interface';


@Component({
  selector: 'transactions-dialog',
  templateUrl: 'contract-dialog.template.html',
...
export class ContractDialogComponent {
  ...
  constructor(@Inject(MatDialogRef) public dialogRef: MatDialogRef<ContractDialogComponent>,
              @Inject(MAT_DIALOG_DATA) public data: ContractDialogInterface) {
